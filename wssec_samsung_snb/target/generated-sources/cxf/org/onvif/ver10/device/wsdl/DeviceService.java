 ...
 * 2012-06-26T15:35:36.881+09:00
 * Generated source version: 2.6.1
 * 
 */
@WebServiceClient(name = "DeviceService", 
                  wsdlLocation = "file:/D:/setup/Apache/apache-cxf-2.6.1/samples/ws_security/wssec_samsung_snb/wsdl/devicemgmt_1.0.wsdl",
...
public class DeviceService extends javax.xml.ws.Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/D:/setup/Apache/apache-cxf-2.6.1/samples/ws_security/wssec_samsung_snb/wsdl/devicemgmt_1.0.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(DeviceService.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "file:/D:/setup/Apache/apache-cxf-2.6.1/samples/ws_security/wssec_samsung_snb/wsdl/devicemgmt_1.0.wsdl");
        }
        WSDL_LOCATION = url;
    }
