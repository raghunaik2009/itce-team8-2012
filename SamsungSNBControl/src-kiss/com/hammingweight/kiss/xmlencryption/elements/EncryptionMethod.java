...
public class EncryptionMethod extends Element {
	public EncryptionMethod(IXmlCipher cipher) {
		setName("EncryptionMethod");
		setNamespace(NameSpaces.XENC_NAMESPACE);
		this.setAttribute(null, "Algorithm", cipher.getAlgorithm());
	}
}
