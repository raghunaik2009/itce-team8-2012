...
class utilityONVIF$3 extends Thread
{
  public void run()
  {
    try
    {
      ...
      arrayOfSoapParam[1] = new SoapParam(this.val$ptz, "Translation");
      arrayOfSoapParam[2] = new SoapParam(((PTZConfiguration)this.val$od.listPTZConfigurations.get(0)).DefaultPTZSpeed, "Speed");
 ...
 * Qualified Name:     net.biyee.android.ONVIF.utilityONVIF.3
