...
int vlc_entry__memcpy (int (*)(void *, void *, int, ...), void *);
int vlc_entry__osd_parser (int (*)(void *, void *, int, ...), void *);
int vlc_entry__fixed32_mixer (int (*)(void *, void *, int, ...), void *);
int vlc_entry__float32_mixer (int (*)(void *, void *, int, ...), void *);
int vlc_entry__stream_filter_httplive (int (*)(void *, void *, int, ...), void *);
int vlc_entry__decomp (int (*)(void *, void *, int, ...), void *);
int vlc_entry__stream_filter_dash (int (*)(void *, void *, int, ...), void *);
...
int vlc_entry__converter_fixed (int (*)(void *, void *, int, ...), void *);
...
int vlc_entry__iomx (int (*)(void *, void *, int, ...), void *);
 ...
 vlc_entry__fixed32_mixer,
 vlc_entry__float32_mixer,
 vlc_entry__stream_filter_httplive,
 vlc_entry__decomp,
 vlc_entry__stream_filter_dash,
